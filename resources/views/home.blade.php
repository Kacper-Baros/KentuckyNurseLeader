...
<div id="myCarousel" class="carousel carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="{{ url('img/1-secondary-flash.jpg') }}" alt="First slide">
        </div>
        <div class="item">
            <img class="second-slide" src="{{ url('img/2-secondary-flash.jpg') }}" alt="Second slide">
        </div>
        <div class="item">
            <img class="third-slide" src="{{ url('img/4-secondary-flash.jpg') }}" alt="Third slide">
        </div>
        <div class="item">
            <img class="third-slide" src="{{ url('img/5-secondary-flash.jpg') }}" alt="Third slide">
        </div>
    </div>
        ...
        <div class="mainbody">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p><img src="{{ url('img/1.jpg') }}" alt="Annual Membership Made Easy" title="Annual Membership Made Easy" width="400" height="600" class="img-responsive image-border"></p>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p><img src="{{ url('img/2.jpg') }}" alt="Scholarships Available to KONL Members" title="Scholarships Available to KONL Members" width="400" height="600" class="img-responsive image-border"></p> 
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p><img src="{{ url('img/3.jpg') }}" alt="KONL Membership Survey" title="KONL Membership Survey" width="400" height="600" class="img-responsive image-border"></p>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <p><img src="{{ url('img/4.jpg') }}" alt="Important Documents" title="Important Documents" width="400" height="600" class="img-responsive image-border"></p>
